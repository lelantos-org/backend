...
use protocol_webserver::handlers::worker::venue_apy;
use protocol_webserver::{RegistryConfig, build_info, build_router, build_state};
use std::sync::Arc;
use tracing::info;
...
async fn main() -> Result<()> {
    ...
    info!(addr = %cfg.bind_addr, "protocol-webserver listening");
